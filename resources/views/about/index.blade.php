...
@section('title', '- I Am Myanmar Co.,Ltd')
@section('content')
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="about-contact">
                                                        ...
                                                        <a class="btn btn-white" href="tel:09-887977772">
                                                            09-887977772
                                                        </a>
                                                    </div>
                                                </div>
    ...
    <section>
        <div class="container py-5 pt-100" style="padding-top: 20px; padding-bottom: 5px">
            <div class="section-title zp-1">
                <div class="row justify-content-md-center">
                    <div class="col-md-8">
                        <div class="tm-sc-section-title section-title text-center">
