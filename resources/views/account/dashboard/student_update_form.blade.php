        ...
        <div class="card-body">
            <form method="POST" action="{{ route('student_account.update', $user->id) }}" autocomplete="off"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('name') is-invalid @enderror"
                            name="name" value="{{ $user->name ?? '' }}" autocomplete="off" autofocus>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="gender" id="Female" value="Female"
                                value="Male" @if ($user->gender == 'Female') checked @endif>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text"
                            ...
                            name="professional_career" value="{{ $user->professional_career ?? '' }}" autocomplete="off"
                            autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('height') is-invalid @enderror"
                            name="height" value="{{ $user->height ?? '' }}" autocomplete="off" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('weight') is-invalid @enderror"
                            name="weight" value="{{ $user->weight ?? '' }}" autocomplete="off" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text"
                            class="form-control @error('qualification') is-invalid @enderror" name="qualification"
                            value="{{ $user->qualification ?? '' }}" autocomplete="off" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text"
                            class="form-control @error('special_skills') is-invalid @enderror" name="special_skills"
                            value="{{ $user->special_skills ?? '' }}" autocomplete="off" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text" class="form-control @error('nrc') is-invalid @enderror"
                            name="nrc" value="{{ $user->nrc ?? '' }}" autocomplete="off" autofocus>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <input id="name" type="text"
                            ...
                            name="visited_sibling" value="{{ $user->visited_sibling ?? '' }}" autocomplete="off"
                            autofocus>
