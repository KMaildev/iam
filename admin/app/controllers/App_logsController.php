...
class App_logsController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				app_logs.RequestCompleted LIKE ?
			)";
			$search_params = array(
		...
		if(!empty($request->orderby)){
			...
			$db->orderBy("app_logs.id", ORDER_TYPE);
		}
		if($fieldname){
	...
	function view($rec_id = null, $value = null){
		...
		if($value){
			...
			$db->where("app_logs.id", $rec_id);; //select record based on primary key
		}
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("app_logs","Timestamp","Action","TableName","SqlQuery","UserID","ServerIP","RequestUrl","RequestData","RequestCompleted");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id","app_logs","Timestamp","Action","TableName","SqlQuery","UserID","ServerIP","RequestUrl","RequestData","RequestCompleted");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'app_logs' => 'required',
	...
	function delete($rec_id = null){
		...
		$db->where("app_logs.id", $arr_rec_id, "in");
