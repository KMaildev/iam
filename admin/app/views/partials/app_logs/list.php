...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="list"  data-display-type="table" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title">App Logs</h4>
                </div>
                <div class="col-sm-3 ">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-app_logs"> App Logs</th>
                                                <th  class="td-Timestamp"> Timestamp</th>
                                                <th  class="td-Action"> Action</th>
                                                <th  class="td-TableName"> Tablename</th>
                                                <th  class="td-SqlQuery"> Sqlquery</th>
                                                <th  class="td-UserID"> Userid</th>
                                                <th  class="td-ServerIP"> Serverip</th>
                                                <th  class="td-RequestUrl"> Requesturl</th>
                                                <th  class="td-RequestData"> Requestdata</th>
                                                <th  class="td-RequestCompleted"> Requestcompleted</th>
                                                <th class="td-btn"></th>
                                            </tr>
                                        </thead>
                                        <?php
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-id"><a href="<?php print_link("app_logs/view/$data[id]") ?>"><?php echo $data['id']; ?></a></td>
                                                    <td class="td-app_logs">
                                                        <span  data-pk="<?php echo $data['id'] ?>" 
                                                            data-url="<?php print_link("app_logs/editfield/" . urlencode($data['id'])); ?>" 
                                                            data-name="app_logs" 
                                                            data-title="Enter App Logs" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="textarea" 
                                                            data-mode="popover" 
                                                    ...
                                                    <th class="td-btn">
                                                        ...
                                                        <a class="btn btn-sm btn-info has-tooltip" title="Edit This Record" href="<?php print_link("app_logs/edit/$rec_id"); ?>">
                                                            <i class="fa fa-edit"></i> Edit
                                                        </a>
                                                        <a class="btn btn-sm btn-danger has-tooltip record-delete-btn" title="Delete this record" href="<?php print_link("app_logs/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
                                        ...
                                        <div class="row justify-content-center">    
                                            <div class="col-md-auto justify-content-center">    
                                                <div class="p-3 d-flex justify-content-between">    
                                                    <button data-prompt-msg="Are you sure you want to delete these records?" data-display-style="modal" data-url="<?php print_link("app_logs/delete/{sel_ids}/?csrf_token=$csrf_token&redirect=$current_page"); ?>" class="btn btn-sm btn-danger btn-delete-selected d-none">
