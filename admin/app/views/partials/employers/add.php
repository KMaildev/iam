                            ...
                            <div>
                                ...
                                <div class="form-group ">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="">
                                                <textarea placeholder="Enter Apply Date" id="ctrl-apply_date"  required="" rows="5" name="apply_date" class=" form-control"><?php  echo $this->set_field_value('apply_date',""); ?></textarea>
                                                <!--<div class="invalid-feedback animated bounceIn text-center">Please enter text</div>-->
                                            </div>
                                        </div>
                                    </div>
