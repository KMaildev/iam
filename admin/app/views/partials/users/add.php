                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <input id="ctrl-account_type"  value="<?php  echo $this->set_field_value('account_type',"company"); ?>" type="hidden" placeholder="Enter Account Type"  required="" name="account_type"  class="form-control " />
                                                    </div>
