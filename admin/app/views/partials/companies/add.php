                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <div class="form-group ">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-8">
                                                                    <div class="">
                                                                        <textarea placeholder="Enter Is Active" id="ctrl-is_active"  required="" rows="5" name="is_active" class=" form-control"><?php  echo $this->set_field_value('is_active',""); ?></textarea>
